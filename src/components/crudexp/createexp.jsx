        ...
        .insert([
          {
            ...
            duration,
            description,
            techs: techArray, // Insert tech stack sebagai array
          },
        ]);
      ...
      >
        ...
        <div className="mb-6">
          ...
          <input
            ...
            required
          />
          <span className="text-sm text-slate-500 ml-1">contoh insert (dipisahkan dengan koma intinya): php, laravel </span>
        </div>
        <button
          type="submit"
